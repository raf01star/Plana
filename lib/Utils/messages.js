...
const jawa = [
  "120363268316418277@newsletter",
    "120363378683159694@newsletter"
];
const MIMETYPE_MAP = {
    image: 'image/jpeg',
    video: 'video/mp4',
...
const mediaAnnotation = [
    {
        ...
        newsletter: {
            ...
            newsletterJid: pickRandom(jawa) || process.env.NEWSLETTER_ID ||
            ...
            newsletterName: "Plana Assist • Information" || process.env.NEWSLETTER_NAME ||
